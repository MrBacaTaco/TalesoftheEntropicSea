...
{
    public class PurpleWisteriaTree3 : ModTile
    {
        public override string Texture => "TalesoftheEntropicSea/Content/Tiles/PurpleWisteriaTree3";
        public override void SetStaticDefaults()
        {
            ...
            TileObjectData.newTile.AnchorBottom = new Terraria.DataStructures.AnchorData(AnchorType.SolidTile, 10, 0);
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("TalesoftheEntropicSea/Content/Tiles/PurpleWisteriaTree3GlowMask").Value;
