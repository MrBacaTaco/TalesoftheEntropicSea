...
{
    public class SkyAbyssCloseSky : CustomSky
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            Texture2D tex = ModContent.Request<Texture2D>("TalesoftheEntropicSea/Assets/Textures/Backgrounds/SkyAbyssClose").Value;

            float parallaxFactor = 0.5f;
            float scale = 1.7f;
            float screenYPercent = 0.75f;
            float xOffset = 100f;
