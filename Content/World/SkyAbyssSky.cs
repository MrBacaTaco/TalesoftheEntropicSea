...
{
    public class SkyAbyssSky : CustomSky
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            Texture2D tex = ModContent.Request<Texture2D>("TalesoftheEntropicSea/Assets/Textures/Backgrounds/SkyAbyssFar").Value;

            float parallaxFactor = 0.2f;
            float scale = 1.5f;
            float screenYPercent = 0.65f;
            float xOffset = 200f;
